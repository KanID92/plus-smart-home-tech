...
import telemetry.collector.model.sensor.SwitchSensorEvent;
...
public class SwitchEventHandler extends BaseSensorHandler {
    ...
    public void handle(SensorEvent sensorEvent) {
        ProducerRecord<String, SwitchSensorAvro> record = new ProducerRecord<>(topic, toAvro(sensorEvent));
        try(KafkaProducer<String, SwitchSensorAvro> producer = new KafkaProducer<>(properties)) {
